...
class Examen(val nombres: Array<String> = Array(4){""}) {
    ...
    fun leerRespuestas(respuestasEstudiante: CharArray) { //Se encargar de recibir y crear la matriz con sus espacios
        if (contador < 4) {
    ...
    fun ToString() { //Se encarga de imprimir todos los datos
        println("")
